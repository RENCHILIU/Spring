...
//TODO: using TestRestTemplate from Spring boot
...
public class HelloRestControllerTest {
    ...
    public void greetWithName() {
        Greeting response = template.getForObject("/rest?name=renchi", Greeting.class);
        assertEquals("Hello, renchi!", response.getMessage());
    }
